...
// MARK: - Date helper for various purposes
public extension Date {
    ...
    /// - Parameter format: DateFormatType
    /// - Parameter timeZone: TimeZoneType
    /// - Parameter locale: Locale
    /// - Parameter isLenient: Bool
    ...
    /// - Parameter strings: [RelativeTimeStringType:String]?
    ...
    /// - Parameter comparison: DateComparisonType
    ...
    /// - Parameter component: DateComponentType
    ...
    /// Date For
    /// - Parameter type: DateForType
    /// - Parameter calendar: Calendar = Calendar.current
    ...
    internal class concurrentFormatterCache {
        ...
        /// Cached Formatter
        /// - Parameter format: String = DateFormatType.standard.stringFormat
        /// - Parameter timeZone: Foundation.TimeZone = Foundation.TimeZone.current
        /// - Parameter locale: Locale = Locale.current
        /// - Parameter isLenient: Bool = true
    ...
    func difference(from: Date) -> (h: Int, m: Int, s: Int, totalSeconds: Int) {
        let second = totalSeconds(from: from)
        let time = secondsToHoursMinutesSeconds(seconds: second)
        return (time.h, time.m, time.s, second)
    }
    
    /// Get the difference of total seconds from a date
    ///
    /// - Parameter from: Date
    /// - Returns: Int
    func totalSeconds(from: Date) -> Int {
        let calendar = Calendar.current
        let dateComponent = calendar.dateComponents([.second], from: from, to: self)
...
extension DateFormatType: Equatable {
    ...
    /// Generic Equatable
    /// - Parameter lhs: DateFormatType
    /// - Parameter rhs: DateFormatType
...
public enum DateComponentType {
    /// second, minute, hour, day, weekday, nthWeekday, week, month, year
...
public enum DateForType {
    /// startOfDay, endOfDay, startOfWeek, endOfWeek, startOfMonth, endOfMonth, tomorrow, yesterday, nearestMinute(minute:Int), nearestHour(hour:Int)
